        ...
        <Section id="publications" title="Publications">
          <div className="space-y-4">
            ...
            <PublicationCard
              ...
              venue="Chemical Engineering Research and Design 218, 839-853, 2025. IF: 4.0, JCR Q2 (Engineering, Chemical)"
              links={[
            ...
            <PublicationCard
              ...
              venue="Applied Energy 377, 124472, 2025. IF: 12.2, JCR Q1 (Engineering, Chemical; Energy & Fuels)"
              links={[
